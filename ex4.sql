...
insert into staff values(1,"Aseel","Professor","Regular",30000,2),
(2,"XYZ","Asst.Professor","Contract",20000,2),
(3,"Shivani","Assoc.Professor","Regular",60000,1),
(4,"Sheza","Professor","Contract",55000,3),
(5,"Mishala","Asst.Professor","Contract",55000,4);

insert into staff values(6,"ABC","Professor","Contract",35000,4);
insert into staff values(7,"PQR","Professor","Regular",50000,4);
